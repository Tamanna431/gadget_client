    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-neutral py-12 px-4">
      <div className="w-full max-w-md bg-white rounded-card shadow-lg p-8 space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-600 mt-2">Login to GadgetVerse</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 bg-primary bg-blue-400 text-black rounded-lg font-medium hover:bg-blue-700 transition disabled:opacity-50"
          >
        ...
        <button
          onClick={fillDemo}
          className="w-full py-2 border border-primary text-primary rounded-lg font-medium hover:bg-primary/5 transition"
        >
          ⚡ Login as Demo User
        </button>
